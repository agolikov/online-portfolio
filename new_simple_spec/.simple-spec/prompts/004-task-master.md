...
- Does it conflict with existing architecture (check `.simple-spec/spec/005-architecture.md`)?
...
On approval: create the task file in `.simple-spec/tasks/[kebab-title].md` using the TEMPLATE.
