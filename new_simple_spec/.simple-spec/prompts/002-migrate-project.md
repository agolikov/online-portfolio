...
- `.simple-spec/spec/001-overview.md` — what the new project is and who it's for
- `.simple-spec/spec/003-features.md` — what's already implemented and what's planned
- `.simple-spec/spec/005-architecture.md` — the architecture and module structure
- `.simple-spec/spec/006-data-models.md` — current data models
...
For each item in MIGRATE, REDESIGN, and PARTIAL, create a task file in `.simple-spec/tasks/`.
...
- `.simple-spec/spec/003-features.md` — add all agreed features to Planned
- `.simple-spec/spec/008-design-notes.md` — note any key decisions made during migration planning
  (e.g. "CSV export was redesigned to use streaming — old version loaded full dataset into memory")
- `.simple-spec/spec/010-changelog.md` — add entry: "Migration planning complete — N tasks queued"
